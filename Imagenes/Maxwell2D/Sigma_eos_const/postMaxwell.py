...
if __name__ == "__main__":
    ...
    for i,param in enumerate(paramList):
        ...
        plt.plot( rhogList,
                  TList,
                  label = r'$a={:n}; \,b={:n}; \,\sigma={:n}$'.format(param[0],param[1],param[2]),
                  linestyle = 'None',
                  mec = colorList[i],
                  marker = mkList[i],
                  mfc = 'None')
    ...
    if args.png == True:
        ...
        plt.savefig( 'vdW_sigma_eos.png', format='png', bbox_inches = 'tight', dpi=600 )

    else:
        
        plt.savefig( 'vdW_sigma_eos.pdf', format='pdf', bbox_inches = 'tight', dpi=600 )
