...
if __name__ == "__main__":
    ...
    Sol = vdw.rhoNonUniformLambda( Tt = 0.99, Tb = 0.9, kappa = 1.0, updateT = False, thcond = 'linear' )
    ...
    with plt.style.context( ('thesis_classic') ):
        ...
        if args.png == True:
            ...
            plt.savefig( 'rhor_TNonUniform_grilla.png', format='png', bbox_inches = 'tight', dpi=600 )

        else:

            plt.savefig( 'rhor_TNonUniform_grilla.pdf', format='pdf', bbox_inches = 'tight', dpi=600 )
