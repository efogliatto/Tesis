...
if __name__ == "__main__":
    ...
    with plt.style.context( ('../../thesis_classic.mplstyle') ):
        ...
        for i, mk in zip( range( args.n + 1 ), mklist ):
            ...
            label = r'$T_b={:.1f}$'.format(TbList[i])
        ...
        if args.png == True:
            ...
            plt.savefig( 'rhor_vdWcolumn_TNonUniform.png', format='png', bbox_inches = 'tight', dpi=600 )

        else:

            plt.savefig( 'rhor_vdWcolumn_TNonUniform.pdf', format='pdf', bbox_inches = 'tight', dpi=600 )
