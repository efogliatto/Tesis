...
\end{equation}
donde $p_{in}$ y $p_{out}$ corresponden al valor de presi\'on en el interior y exterior de la burbuja respectivamente, lejos de la interfase. A modo de ejemplo, en la \fig{fig:laplace_1_3D} se muestran los resultados de la evoluci\'on de la burbuja estacionaria, donde puede observarse le distribuci\'on de densidad inicial y final, as\'i como el perfil de presi\'on a lo largo de la direcci\'on $x$, tomando como origen el centro de la burbuja.
\begin{figure}[htb]
    \centering
