...
\begin{figure}[ht]
	...
	\caption{Experimento num\'erico para la determinaci\'on del calor latente. \red{poner la figura correcta}}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.75\textwidth]{FC72/Fint/pr_sigma}
	\caption{Construcci\'on de Maxwell obtenida con la fuerza de interacci\'on de la \eq{eq:f_int_chen} y $\beta=1.25$. \red{poner figura correcta}}
