...
Por lo tanto, si se reescribe a la \eq{eq:vdw_maxwell_analitica} usando variables reducidas:
\begin{equation}
a,
\end{equation}
y a la presi\'on de coexistencia reducida como
\begin{equation}
a
\end{equation}